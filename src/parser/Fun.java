...
q = new ListNode(new VarNode(t2, k));
                  p = new ListNode(new VarNode(t1, q));
          label_2:
          while (true) {
            switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
            case COMMA:{
...
{if ("" != null) return e;}
  ...
  Token tn = null;
      ...
      e = factor();
{if ("" != null) return ( (t == null) ? e : new UnaryNode(t, tn, e) );}
    throw new Error("Missing return statement in function");
    } finally {
...
{if ("" != null) return e1;}
  ...
  final public ExpreNode equaltyExpression() throws ParseException {
    trace_call("equaltyExpression");
    try {ExpreNode e1 = null, e2;
  Token t;
      e1 = numexpr();
      label_9:
      while (true) {
        ...
        e2 = numexpr();
e1 = new EqualtyNode(t, e1, e2);
      }
{if ("" != null) return e1;}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("equaltyExpression");
    }
  }

  final public ExpreNode condANDexpression() throws ParseException {
    trace_call("condANDexpression");
    try {ExpreNode e1 = null, e2;
  Token t;
      e1 = equaltyExpression();
      label_10:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case AND:{
...
{if ("" != null) return e1;}
  ...
  final public ExpreNode condORexpression() throws ParseException {
    trace_call("condORexpression");
    try {ExpreNode e1 = null, e2;
  Token t;
      e1 = condANDexpression();
      label_11:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case XOR:
...
e1 = new IndexNode(t1, e1, e2);
          ...
          case DOT:{
            //  	LOOKAHEAD(3) Isto está no livro, não sei se se aplica ao nosso caso
  ...
  private boolean jj_3_2()
 {
  ...
  static {
   ...
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x400000,0x800,0x4000,0x400000,0x800,0x400000,0x400000,0x800,0x4000,0x800,0x7f0080,0x8,0x0,0x0,0x0,0x0,0x0,0x0,0x7,0x7,0x10,0x60,0x60,0x7,0x7,0x400000,0x800,0x400000,0x8800,0x80,0x8800,0x7f0088,0x7f0088,0x402200,0x400000,0x800,0x400000,0x0,0x0,0x400000,0x0,0x0,0x400000,0x400000,0x7f0088,0x400000,0x402200,0x0,0x4000,0x7f0088,0x0,0x0,};
   }
